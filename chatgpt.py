...
if PERSIST and os.path.exists("persist"):
  ...
  loader = TextLoader("data/data.txt") # Use this loader = DirectoryLoader("data/")t
  csv_loader = CSVLoader(file_path='/Users/rabat/Desktop/chatgpt-retrieval/data/projects.csv')
  if PERSIST:
